...
| #     | Rule                                                                                                                                              | Rationale                                              |
| ----- | ------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------ |
| 2.1.1 | Names must be **descriptive and intention-revealing**. A reader should understand _what_ and _why_ without reading the implementation.            | Reduces cognitive load and onboarding time.            |
