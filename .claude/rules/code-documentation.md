...
| **Responsibilities** | Yes             | What this class owns and does _not_ own.                                                 |
...
| #     | Rule                                                                                                                                                                    |
| ----- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 4.4.1 | Comment the **why**, not the _what_. The code itself shows what happens; comments explain intent, trade-offs, and context.                                              |
