/**
 * Unit tests for PodcastUploadForm field indicators.
 *
 * Verifies:
...
describe('PodcastUploadForm — field indicators', () => {
  it('renders * indicator on required field labels in create mode', () => {
    const { container } = render(<PodcastUploadForm mode="create" />);
  ...
  it('renders * on Title, Description, Domain, Year but NOT Thumbnail in edit mode', () => {
    const { container } = render(<PodcastUploadForm mode="edit" />);
