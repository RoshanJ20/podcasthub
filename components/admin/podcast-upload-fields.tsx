/**
 * Grouped file-upload fields for the podcast upload/edit form.
 *
...
import type { PodcastFormData } from './podcast-upload-form';
...
interface PodcastUploadFieldsProps {
  /** Whether the parent form is creating or editing a podcast. */
  mode: 'create' | 'edit';
  /** Pre-existing podcast data used to determine helper text in edit mode. */
...
/**
 * Renders all six file-upload fields used in the podcast upload/edit form.
 *
 * @param mode - 'create' or 'edit'; controls required state and helper text.
 * @param initialData - Existing podcast data for edit-mode helper messages.
 ...
 */
export function PodcastUploadFields({
  mode,
  initialData,
  thumbnailFile,
  shortTranscript,
