/**
 * AuditBriefUploadWizard — Main orchestrator for the three-step audit brief upload flow.
 *
...
/**
 * Props for the AuditBriefUploadWizard component.
 *
 ...
 */
export interface AuditBriefUploadWizardProps {
...
export interface AuditBriefUploadWizardHandle {
...
/**
 * Main wizard component orchestrating the three-step audit brief upload flow.
 *
 ...
 *
 * @param props - Component props (see AuditBriefUploadWizardProps).
 ...
 */
export const AuditBriefUploadWizard = forwardRef<
  AuditBriefUploadWizardHandle,
  AuditBriefUploadWizardProps
>(function AuditBriefUploadWizard({ mode = 'create', initialData, onSuccess, onStepChange }, ref) {
  const {
    currentStep,
    goToStep,
    form,
...
AuditBriefUploadWizard.displayName = 'AuditBriefUploadWizard';
