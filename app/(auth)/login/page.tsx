    ...
    <main className="flex min-h-screen items-center justify-center bg-[radial-gradient(circle_at_top,oklch(from_var(--brand-500)_95%_0.02_h_/_0.4),transparent_46%),var(--bg-canvas)] px-4 py-10 dark:bg-[radial-gradient(circle_at_top,oklch(from_var(--brand-500)_27%_0.06_h_/_0.35),transparent_46%),var(--bg-canvas)]">
      <LoginPageCard>
        <div className="space-y-2 text-center">
          <p className="inline-flex rounded-full border border-border-default bg-subtle/60 px-2.5 py-1 text-[11px] font-medium uppercase tracking-[0.08em] text-secondary-text dark:border-border-subtle dark:bg-surface-muted/40">
            Enterprise Workspace
          </p>
          <h1 className="text-xl font-semibold tracking-tight text-primary-text">The Audit Brief</h1>
        ...
        <p className="text-center text-sm text-secondary-text">
          ...
          <Link href="/register" className="font-medium text-link underline-offset-4 hover:text-link-hover hover:underline dark:text-brand-400 dark:hover:text-link-hover">
            Create one
          </Link>
        </p>
      </LoginPageCard>
